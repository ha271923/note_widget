...
public class NoteWidgetService extends AppWidgetService
{
	...
	private void updateNoteWidgetSize(int appWidgetId)
	{
        ...
        Log.i(TAG,"noteWidget.width="+noteWidget.width+"    noteWidget.height="+noteWidget.height);

        DisplayMetrics metrics2 = getApplication().getApplicationContext().getResources().getDisplayMetrics();
        Log.i(TAG,"metrics2.widthPixels="+metrics2.widthPixels+"    metrics2.heightPixels="+metrics2.heightPixels);
	...
	public Bitmap getViewImage(View view)
	{
        ...
        if(width!=0 && height!=0) {
            Log.i(TAG, "getMeasuredWidth=" + width + "    getMeasuredHeight=" + height);
